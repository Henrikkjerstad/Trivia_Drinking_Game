...
questions_answers = {
    ...
    "Who was the highest-paid athlete in 2022?": "Lionel Messi",
    ...
    "What is the title of the 2021 James Bond film, Daniel Craig's last appearance as Bond?": "No Time to Die",
...
def play_trivia_game(questions_answers):
    ...
    if lives > 0:
        if difficulty == "Easy":
            print("You've won! Choose 1 person to finish their drink.")
        elif difficulty == "Normal":
            print("You've won! Choose 3 people to finish their drink.")
        elif difficulty == "Norwegian":
            print("You've won! Everyone else has to finish their drink.")
    else:
        if difficulty == "Easy":
            print("Game Over. You have to finish your drink.")
        elif difficulty == "Normal":
            print("Game Over. You have to finish two drinks.")
        elif difficulty == "Norwegian":
            print("Game Over. You have to finish 5 drinks.")
