...
questions_answers = {
    ...
    "Which country in Europe has the largest rock sculpture?": "Romania",
    "From where did the creator of Python take inspiration for its name?": "Monty Python",
    "What is the only country to have played in every single soccer World Cup?": "Brazil"
}
